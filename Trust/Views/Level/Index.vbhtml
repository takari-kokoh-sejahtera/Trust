@ModelType PagedList.IPagedList(Of Trust.Trust.Cn_Levels)
                    ...
                    <tbody>
                        ...
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.Level_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Details", "Details", New With {.id = item.Level_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Delete", "Delete", New With {.id = item.Level_ID})
                                </td>
                            </tr>
                        Next
                    </tbody>
