@ModelType PagedList.IPagedList(Of Trust.Trust.Tr_Quotation)
                ...
                <Table Class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @Html.DisplayNameFor(Function(model) model(0).Quotation_Validity)
                            </th>
                            <th>
                            ...
                            <th>
                                @Html.DisplayNameFor(Function(model) model(0).IsDeleted)
                            </th>
                            @*<th></th>*@
                            <th></th>
                            <th></th>
                    ...
                    <tbody>
                        ...
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.Quotation_Validity)
                                </td>
                                <td style="white-space:nowrap">
                                ...
                                <td style="white-space:nowrap">
                                    @If Not item.IsApplication Then
                                        @Html.ActionLink("Delete", "Delete", New With {.id = item.Quotation_ID})
                                    End If
                                </td>
                                <td style="white-space:nowrap">
                                    @If item.Status = "Finish" Then
                                        @Html.ActionLink("Print", "Zip", New With {.id = item.Quotation_ID})
                                    End If
                                    @*@Html.ActionLink("Print", "Zip", New With {.id = item.Quotation_ID})*@
                                </td>
                                <td style="white-space:nowrap">
                                    @If item.IsNotApproved Then
                                        @Html.ActionLink("Not Approve", "Details", New With {.id = item.Quotation_ID})
                                    End If
                                </td>
                            </tr>
                        Next
