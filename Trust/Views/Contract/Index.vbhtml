                        ...
                        @For Each item In Model
                            @<tr>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.Contract_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Print", "Zip", New With {.id = item.Contract_ID})
                                </td>
                                <td style="white-space:nowrap">
                                ...
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.PerMonth)
                                </td>
                                <td style="white-space:nowrap">
