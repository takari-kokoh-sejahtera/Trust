...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.ContractDetail_ID, "Type", htmlAttributes:=New With {.class = "control-label col-md-2"})
            <div class="col-md-10">
...
@Section Scripts
    <script>
        ...
        $('#Contract_ID').change(function () {
            ...
            var t = $(this).val();
            $.ajax({
                url: '@Url.Action("GetContraactDetail", "TemporaryCar")?ID=' + t,
                type: 'POST',
                dataType: 'json',
