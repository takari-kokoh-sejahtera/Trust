        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @*@Html.DropDownList("CustomerExists_ID", Nothing, "Please select", htmlAttributes:=New With {.class = "form-control"})*@
                        @Html.DropDownList("CustomerExists_ID", Nothing, "Please select", htmlAttributes:=New With {.class = "form-control", .id = "customer", .disabled = "true"})
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @Html.DropDownList("CompanyGroup_ID", Nothing, "Please select", htmlAttributes:=New With {.class = "form-control", .id = "company"})
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        ...
                        @Html.DropDownList("PT", Nothing, "--", htmlAttributes:=New With {.class = "form-control", .id = "pt"})
                    ...
                    <div class="col-md-3">
                        @Html.DropDownList("Tbk", Nothing, "--", htmlAttributes:=New With {.class = "form-control", .id = "tbk"})
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @Html.DropDownList("City_id", Nothing, "Please select", htmlAttributes:=New With {.class = "form-control", .id = "City_id"})
                ...
                <table id="detailsTable" class="table table-hover">
                    ...
                    <tbody>
                        @For Each x In ViewBag.detail
                            @<tr><td>@x.Transaction_Type</td><td>@x.IsVehicleExists</td><td id=@x.VehicleExists_ID>@x.license_no</td><td id=@x.Brand_ID>@x.Brand_Name</td><td id=@x.Model_ID>@x.Type</td><td>@x.IsJakarta</td><td>@String.Format("{0:n}", x.Lease_price)</td> <td>@x.Qty</td><td>@x.Year</td> <td>@x.Lease_long</td> <td><a data-itemId=@x.ProspectCustomerDetail_ID href="#" Class="deleteItem">Remove</a></td></tr>
                        Next
                    </tbody>
                </table>
            </div>
    ...
    <script>
        ...
        $("#addToList").click(function (e) {
            ...
            if ($("#IsVehicleExists:checked").val() == "true") {
                ...
                var productItem = '<tr><td>' + Type + '</td><td>' + true + '</td><td id="' + vehicleid + '">' + vehicle + '</td><td></td><td></td><td></td><td>' + price + '</td><td></td><td></td><td>' + long + '</td><td><a data-itemId="0" href="#" class="deleteItem">Remove</a></td></tr>';
                detailsTableBody.append(productItem);
                clearItem();
            }
            else {
                if ($.trim($("#Transaction_Type").val()) == "" || $.trim($("#Brand_ID").val()) == "" || $("#Transaction_Type").val() == "" || $("#IsJakarta").val() == "" || $.trim($("#Model_ID").val()) == "" || $.trim($("#Lease_price").val()) == "" || !$.isNumeric(Number($("#Lease_price")[0].value.replace(/,/g, ""))) || $.trim($("#Qty").val()) == "" || !$.isNumeric($("#Qty").val()) || $.trim($("#Year").val()) == "" || !$.isNumeric($("#Year").val()) || $.trim($("#Lease_long").val()) == "" || !$.isNumeric($("#Lease_long").val()) ) return;
                ...
                var productItem = '<tr><td>' + Type + '</td><td>' + false + '</td><td></td><td id="' + brandid + '">' + brand + '</td><td id="' + modelid + '">' + model + '</td><td>' + IsJakarta + '</td><td>' + price + '</td><td>' + qty + '</td><td>' + year + '</td><td>' + long + '</td><td><a data-itemId="0" href="#" class="deleteItem">Remove</a></td></tr>';
                detailsTableBody.append(productItem);
                clearItem();
            }
        });
        ...
        function saveOrder(data) {
            return $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                url: "@Url.Action("EditOrder", "Prospect")",
                data: data,
                success: function (data) {
        ...
        $("#saveOrder").click(function (e) {
            ...
            $.each($("#detailsTable tbody tr"), function () {
                orderArr.push({
                    ProspectCustomerDetail_ID: $(this).find('a').attr('data-itemId'),
            ...
            orderHD.push({
                ProspectCustomer_ID: $("#ProspectCustomer_ID").val(),
        ...
        $(document).on('click', 'a.deleteItem', function (e) {
            ...
            if (id == "0") {
                ...
                deletedetail.push({ ProspectCustomerDetail_ID: id });
                $(this).parents('tr').css("background-color", "#ff6347").fadeOut(800, function () {
                    $(this).remove();
                });
            }
