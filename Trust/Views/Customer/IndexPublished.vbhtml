        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools">
                    ...
                    @Using (Html.BeginForm("IndexPublished", ViewData("Title").ToString(), FormMethod.Get))
                ...
                <Table Class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @Html.DisplayNameFor(Function(model) model(0).Published)
                            </th>
                            <th>
                                @Html.DisplayName("Contracted By")
                            </th>
                            <th>
                        ...
                        @For Each item In Model
                            @<tr>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "EditPublished", New With {.id = item.Customer_ID})
                                </td>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.Published)
                                </td>
                                <td style="white-space:nowrap">
