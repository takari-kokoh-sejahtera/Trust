@ModelType PagedList.IPagedList(Of Trust.Trust.Cn_ApprovalUser)
@Imports PagedList.Mvc
@Code
    ViewData("Title") = "ApprovalUser1"
End Code
            ...
            <div Class="box-body table-responsive no-padding">
                <Table Class="table table-hover">
                    <thead>
                        ...
                        <tr>
                            <th>
                                @Html.ActionLink("User", "Index", New With {.sortOrder = "User", .currentFilter = ViewBag.CurrentFilter, .pageSize = ViewBag.pageSize})
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.ApprovalUser_ID}) |
                                    @Html.ActionLink("Details", "Details", New With {.id = item.ApprovalUser_ID}) |
                                    @Html.ActionLink("Delete", "Delete", New With {.id = item.ApprovalUser_ID})
                                </td>
                            </tr>
                        Next
                    </tbody>
