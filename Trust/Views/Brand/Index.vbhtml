@ModelType PagedList.IPagedList(Of Trust.Trust.Ms_Vehicle_Brands)
                ...
                <Table Class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @Html.ActionLink("Description", "Index", New With {.sortOrder = "Description", .currentFilter = ViewBag.CurrentFilter, .pageSize = ViewBag.pageSize})
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.Brand_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Details", "Details", New With {.id = item.Brand_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Delete", "Delete", New With {.id = item.Brand_ID})
                                </td>
                            </tr>
                        Next
                    </tbody>
