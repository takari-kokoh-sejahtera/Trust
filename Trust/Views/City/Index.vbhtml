@ModelType PagedList.IPagedList(Of Trust.Trust.Ms_Citys)
                ...
                <Table Class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th> 
                                @Html.ActionLink("Provinsi", "Index", New With {.sortOrder = "Provinsi", .currentFilter = ViewBag.CurrentFilter, .pageSize = ViewBag.pageSize})
                            </th>
                            <th>
                                @Html.DisplayName("Expedition Cost")
                            </th>
                            <th>
                                @Html.DisplayName("Kode Plat")
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.Provinsi)
                                </td>
                                <td style="white-space:nowrap">
                                    @String.Format("{0:n}", item.Expedition_Cost)
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.Kode_Plat)
                                </td>
                                <td style="white-space:nowrap">
                                ...
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.CIty_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Details", "Details", New With {.id = item.CIty_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Delete", "Delete", New With {.id = item.CIty_ID})
                                </td>
                            </tr>
                        Next
                    </tbody>
