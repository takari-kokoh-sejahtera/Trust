@ModelType PagedList.IPagedList(Of Trust.Trust.Cn_GMs)
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools">
                    ...
                    @Using (Html.BeginForm("Index", "GM", FormMethod.Get))
            ...
            <div Class="box-body table-responsive no-padding">
                <Table Class="table table-hover">
                    <thead>
                        <tr>
                            <th>
                                @Html.ActionLink("GM", "Index", New With {.sortOrder = "GM", .currentFilter = ViewBag.CurrentFilter, .pageSize = ViewBag.pageSize})
                            </th>
                            <th>
                        ...
                        @For Each item In Model
                            @<tr>
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.GM)
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.Cn_Directorats.Directorat)
                                </td>
                                <td style="white-space:nowrap">
                                ...
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.GM_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Details", "Details", New With {.id = item.GM_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Delete", "Delete", New With {.id = item.GM_ID})
                                </td>
                            </tr>
                        Next
                    </tbody>
