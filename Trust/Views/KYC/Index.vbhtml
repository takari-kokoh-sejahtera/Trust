        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools">
                    ...
                    @Using (Html.BeginForm("Index", "KYC", FormMethod.Get))
                    ...
                    @For Each item In Model
                        @<tr>
                             <td style="white-space:nowrap">
                                 @Html.ActionLink("Edit", "Edit", New With {.id = item.KYC_ID}) |
                                 @Html.ActionLink("Details", "Details", New With {.id = item.KYC_ID}) |
                                 @Html.ActionLink("Delete", "Delete", New With {.id = item.KYC_ID})
                                 @*@Html.ActionLink("Print", "Zip", New With {.id = item.KYC_ID})*@
                             </td>
