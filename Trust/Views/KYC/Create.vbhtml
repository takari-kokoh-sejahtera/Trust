...
@Using (Html.BeginForm("Create", "KYC", FormMethod.Post, htmlAttributes:=New With {.enctype = "multipart/form-data"}))
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.DropDownList("Customer_ID", Nothing, "Please Select", htmlAttributes:=New With {.class = "form-control"})
        ...
        <hr>
        <div class="form-group">
            @Html.Label("1 DoE", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("2 AoA (Adjustment UUPT)", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("3 NPWP", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        ...
        <hr />
        <div class="form-group">
            @Html.Label("4 NPWP SKT", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        ...
        <hr />
        <div class="form-group">
            @Html.Label("5 SPPKP", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        ...
        <hr />
        <div class="form-group">
            @Html.Label("6 Business Lisence", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        ...
        <hr />
        <div class="form-group">
            @Html.Label("7 Certificate of Company Registration", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("8 SKDP", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        ...
        <hr />
        <div class="form-group">
            @Html.Label("9 Deed of Change", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        ...
        <hr />
        <div class="form-group">
            @Html.Label("10 Deed of Change", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("11 Deed of Change", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("12 Deed of Change", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("13 Deed of Change", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("14 Deed Change of BoD & BoC", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("15 Composition of BoD & BoC", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <div class="form-group">
            @Html.Label("A. BoD", htmlAttributes:=New With {.class = "control-label col-md-4"})
        </div>
        <br />
        <div class="form-group">
                                ...
                                @if Model.DetailDirector IsNot Nothing Then
                                    @For i = 0 To Model.DetailDirector.Count - 1
                                        @<tr style="white-space:nowrap">
                                            ...
                                            <td style="white-space:nowrap">@Html.RadioButton("DetailDirector[" + i.ToString + "].Gender", "Mr")</td>
                                            <td style="white-space:nowrap">@Html.RadioButton("DetailDirector[" + i.ToString + "].Gender", "Mrs")</td>
                                            <td style="white-space:nowrap">@Html.RadioButton("DetailDirector[" + i.ToString + "].Gender", "Ms")</td>
        ...
        <hr />
        <div class="form-group">
            @Html.Label("B. BoC", htmlAttributes:=New With {.class = "control-label col-md-4"})
        </div>
        <br />
                                ...
                                @if Model.DetailCommissioner IsNot Nothing Then
                                    @For i = 0 To Model.DetailCommissioner.Count - 1
                                        @<tr style="white-space:nowrap">
                                            ...
                                            <td style="white-space:nowrap">@Html.RadioButton("DetailCommissioner[" + i.ToString + "].Gender", "Mr")</td>
                                            <td style="white-space:nowrap">@Html.RadioButton("DetailCommissioner[" + i.ToString + "].Gender", "Mrs")</td>
                                            <td style="white-space:nowrap">@Html.RadioButton("DetailCommissioner[" + i.ToString + "].Gender", "Ms")</td>
        ...
        <hr />
        <div class="form-group">
            @Html.Label("12", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            @Html.Label("13 Important Notes", htmlAttributes:=New With {.class = "control-label"})
        </div>
        <br />
    ...
    <script>
        ...
        $("#addShareholder").click(function (e) {
            ...
            var productItem = '<tr><td style="white-space:nowrap"><input name="DetailShareholder[' + rowCount + '].Shareholder_Name" type="text" class="form-control"></td>' +
                '<td style="white-space:nowrap"><input class="form-control" name="DetailShareholder[' + rowCount + '].AmountofShares" type="number"></td>' +
                '<td style="white-space:nowrap"><input class="form-control" name="DetailShareholder[' + rowCount + '].Nominal_Amount" type="number"></td></tr>';
            detailsTableBody.append(productItem);
        });
        ...
        //remove item
        //$(document).on('click', 'a.deleteItemDirector', function (e) {
        //    e.preventDefault();
        //    $(this).parents('tr').css("background-color", "#ff6347").fadeOut(800, function () {
        //        $(this).remove();
        //    });
        //});
        //$(document).on('click', 'a.deleteItemCommissioner', function (e) {
        //    e.preventDefault();
        //    $(this).parents('tr').css("background-color", "#ff6347").fadeOut(800, function () {
        //        $(this).remove();
        //    });
        //});
        //$(document).on('click', 'a.deleteItemSigner', function (e) {
        //    e.preventDefault();
        //    $(this).parents('tr').css("background-color", "#ff6347").fadeOut(800, function () {
        //        $(this).remove();
        //    });
        //});
        //$(document).on('click', 'a.deleteItemShare', function (e) {
        //    e.preventDefault();
        //    $(this).parents('tr').css("background-color", "#ff6347").fadeOut(800, function () {
        //        $(this).remove();
        //    });
