...
@Using (Html.BeginForm("Edit", "KYC", FormMethod.Post, htmlAttributes:=New With {.enctype = "multipart/form-data"}))
    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.Customer_Name)

        <div class="form-group">
            @Html.LabelFor(Function(model) model.Customer_ID, htmlAttributes:=New With {.class = "control-label col-md-2"})
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.Customer_Name, New With {.htmlAttributes = New With {.class = "form-control", .disabled = "disabled"}})
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.DropDownList("Legal_Domicile_City_ID", Nothing, htmlAttributes:=New With {.class = "form-control"})
    ...
    <script>
        ...
        $("#addShareholder").click(function (e) {
            ...
            var productItem = '<tr><td style="white-space:nowrap"><input name="DetailShareholder[' + rowCount + '].Shareholder_Name" type="text" class="form-control"></td>' +
                '<td style="white-space:nowrap"><input name="DetailShareholder[' + rowCount + '].AmountofShares_Str" type="number" class="form-control"></td>' +
                '<td style="white-space:nowrap"><input name="DetailShareholder[' + rowCount + '].Nominal_Amount_Str" type="number" class="form-control"></td></tr>';
            detailsTableBody.append(productItem);
        });
