    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    @Html.DropDownList("Term_Of_Payment", Nothing, "Please select", htmlAttributes:=New With {.class = "form-control"})
...
@Section Scripts
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#AssuranceExtra")[0].value = $.number($("#AssuranceExtra")[0].value, 2);
        ...
        function saveOrder(data) {
            return $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                url: "@Url.Action("EditData", "Calculate")",
                data: data,
