        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @Html.DropDownList("Expedition_Status", Nothing, htmlAttributes:=New With {.class = "form-control", .disabled = "disabled"})
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        @Html.EditorFor(Function(model) model.Replacement_Percent, New With {.htmlAttributes = New With {.class = "form-control", .id = "Replacement_Percent"}})
                        @Html.ValidationMessageFor(Function(model) model.Replacement_Percent, "", New With {.class = "text-danger"})
                    </div>
                    @Html.Label("%", htmlAttributes:=New With {.class = "control-label col-md-1"})
                    @Html.CheckBox("Replacement_Tick", Model.Replacement_Tick, New With {.disabled = "disabled"})
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        @Html.EditorFor(Function(model) model.Maintenance_Percent, New With {.htmlAttributes = New With {.class = "form-control", .id = "Maintenance_Percent"}})
                        @Html.ValidationMessageFor(Function(model) model.Maintenance_Percent, "", New With {.class = "text-danger"})
                    </div>
                    @Html.Label("%", htmlAttributes:=New With {.class = "control-label col-md-1"})
                    @Html.CheckBox("Maintenance_Tick", Model.Maintenance_Tick, New With {.disabled = "disabled"})
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        @Html.EditorFor(Function(model) model.STNK_Percent, New With {.htmlAttributes = New With {.class = "form-control", .id = "STNK_Percent"}})
                        @Html.ValidationMessageFor(Function(model) model.STNK_Percent, "", New With {.class = "text-danger"})
                    </div>
                    @Html.Label("%", htmlAttributes:=New With {.class = "control-label col-md-1"})
                    @Html.CheckBox("STNK_Tick", Model.STNK_Tick, New With {.disabled = "disabled"})
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        @Html.EditorFor(Function(model) model.Overhead_Percent, New With {.htmlAttributes = New With {.class = "form-control", .id = "Overhead_Percent"}})
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        @Html.EditorFor(Function(model) model.Assurance_Percent, New With {.htmlAttributes = New With {.class = "form-control", .id = "Assurance_Percent"}})
                        @Html.ValidationMessageFor(Function(model) model.Assurance_Percent, "", New With {.class = "text-danger"})
                    </div>
                    @Html.Label("%", htmlAttributes:=New With {.class = "control-label col-md-1"})
                    @Html.CheckBox("Assurance_Tick", Model.Assurance_Tick, New With {.disabled = "disabled"})
                </div>
                <div class="form-group">
                    @Html.LabelFor(Function(model) model.AssuranceExtra, htmlAttributes:=New With {.class = "control-label col-md-2"})
                    <div class="col-md-10">
                        @Html.EditorFor(Function(model) model.AssuranceExtra, New With {.htmlAttributes = New With {.class = "form-control"}})
                ...
                <div class="form-group">
                    @Html.LabelFor(Function(model) model.RemarkDeviasi, htmlAttributes:=New With {.class = "control-label col-md-2"})
                    <div class="col-md-10">
                        @Html.EditorFor(Function(model) model.RemarkDeviasi, New With {.htmlAttributes = New With {.class = "form-control"}})
                        @Html.ValidationMessageFor(Function(model) model.RemarkDeviasi, "", New With {.class = "text-danger"})
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    @Html.Label("Replacement", htmlAttributes:=New With {.class = "control-label col-md-3"})
                    <div class="col-md-9">
                        @Html.RadioButtonFor(Function(x) x.GoalSeek, "Replacement", New With {.htmlAttributes = New With {.class = "form-control"}})
                    </div>
                </div>
                <div class="form-group">
                    @Html.Label("Maintenance", htmlAttributes:=New With {.class = "control-label col-md-3"})
                    <div class="col-md-9">
                        @Html.RadioButtonFor(Function(x) x.GoalSeek, "Maintenance", New With {.htmlAttributes = New With {.class = "form-control"}})
                    </div>
                </div>
                <div class="form-group">
                    @Html.Label("STNK", htmlAttributes:=New With {.class = "control-label col-md-3"})
                    <div class="col-md-9">
                        @Html.RadioButtonFor(Function(x) x.GoalSeek, "STNK", New With {.htmlAttributes = New With {.class = "form-control"}})
                    </div>
                </div>
                <div class="form-group">
                    @Html.Label("Overhead", htmlAttributes:=New With {.class = "control-label col-md-3"})
                    <div class="col-md-9">
                        @Html.RadioButtonFor(Function(x) x.GoalSeek, "Overhead", New With {.htmlAttributes = New With {.class = "form-control"}})
                    </div>
                </div>
                <div class="form-group">
                    @Html.Label("Insurance", htmlAttributes:=New With {.class = "control-label col-md-3"})
                    <div class="col-md-9">
                        @Html.RadioButtonFor(Function(x) x.GoalSeek, "Assurance", New With {.htmlAttributes = New With {.class = "form-control"}})
                    </div>
                </div>
                <div class="form-group">
    ...
    <script>
        function saveOrder(data) {
            return $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                url: "@Url.Action("EditDataDeviasiCalNew", "Calculate")",
                data: data,
                success: function (data) {
                    if (data.result == "Success") {
                        alert("Success! Calculate Is Complete!");
                        window.location.href = '@Url.Action("IndexDeviasi", "Calculate")'
        ...
        $("#save").click(function (e) {
            ...
            orderHD.push({
                ...
                RemarkDeviasi: $("#RemarkDeviasi").val()                
            });
        ...
        function calculate() {
            ...
            var IsVehicleExists = document.getElementById("IsVehicleExists").checked;
            var New_Vehicle_Price = $("#New_Vehicle_Price")[0].value.replace(/,/g, "");
            var Gross = amount;

            $.ajax({
                url: '@Url.Action("FillIRRGoalSeek", "Calculate")?Expedition_Status=' + Expedition_Status + '&PayMonth=' + PayMonth + '&Cost_Price=' + Cost_Price + '&DP=' + DP + '&DPPercent=' + DPPercent + '&Replacement=' + Replacement + '&Maintenance=' + Maintenance + '&STNK=' + STNK + '&Overhead=' + Overhead + '&Insurance=' + Insurance + '&Price_Month=' + Price_Month + '&RV=' + RV + '&RVPercent=' + RVPercent + '&lama=' + lama + '&Expedition_Cost=' + Expedition_Cost + '&type=' + type + '&Payment=' + Payment + '&Term_Of_Payment=' + Term_Of_Payment + '&Modification=' + Modification + '&GPS_Cost=' + GPS_Cost + '&GPS_CostPerMonth=' + GPS_CostPerMonth + '&Agent_Fee=' + Agent_Fee + '&Agent_FeePerMonth=' + Agent_FeePerMonth + '&Other=' + Other + '&Keur=' + Keur + '&Funding_Rate=' + Funding_Rate + '&Depresiasi=' + Depresiasi + '&DepresiasiPercent=' + DepresiasiPercent + '&Funding_Interest=' + Funding_Interest + '&GoalSeek=' + GoalSeek + '&GoalSeekVal=' + GoalSeekVal + '&Lease_Profit=' + Lease_Profit + '&Lease_Profit_Percent=' + Lease_Profit_Percent + '&IsVehicleExists=' + IsVehicleExists + '&New_Vehicle_Price=' + New_Vehicle_Price + '&Gross=' + Gross,
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    if (data.success == "true") {
                        if (GoalSeek == "Replacement")
                        {
                            $("#Replacement")[0].value = $.number(data.Replacement, 2);
                            $("#Replacement_Percent")[0].value = data.Replacement_Percent;
                            $("#Replacement_Percent_Before")[0].value = data.Replacement_Percent;
                        } else if (GoalSeek == "Maintenance") {
                            $("#Maintenance")[0].value = $.number(data.Maintenance, 2);
                            $("#Maintenance_Percent")[0].value = data.Maintenance_Percent;
                            $("#Maintenance_Percent_Before")[0].value = data.Maintenance_Percent;
                        } else if (GoalSeek == "STNK") {
                            $("#STNK")[0].value = $.number(data.STNK, 2);
                            $("#STNK_Percent")[0].value = data.STNK_Percent;
                            $("#STNK_Percent_Before")[0].value = data.STNK_Percent;
                        } else if (GoalSeek == "Overhead") {
                            $("#Overhead")[0].value = $.number(data.Overhead, 2);
                            $("#Overhead_Percent")[0].value = data.Overhead_Percent;
                        } else if (GoalSeek == "Assurance") {
                            $("#Assurance")[0].value = $.number(data.Assurance, 2);
