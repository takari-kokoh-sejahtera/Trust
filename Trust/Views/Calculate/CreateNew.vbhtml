        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @Html.TextBox("model", Nothing, htmlAttributes:=New With {.class = "form-control", .id = "model", .readonly = "readonly"})
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        @Html.TextBox("harga", Nothing, htmlAttributes:=New With {.class = "form-control", .id = "harga", .readonly = "readonly"})
                    </div>
                </div>
            </div>
            <div class="col-md-6">
