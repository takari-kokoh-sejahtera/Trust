...
@*<p>
        @Html.ActionLink("Simulation", "CalculateSimulation")
    </p>*@
                ...
                <Table Class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @Html.DisplayNameFor(Function(model) model(0).Lease_long)
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.DisplayFor(Function(modelItem) item.Lease_long)
                                </td>
                                <td style="white-space:nowrap">
                                ...
                                <td style="white-space:nowrap">
                                    @If (item.IsQuotation = False) Then
                                        @Html.ActionLink("Edit", "Edit", New With {.id = item.Calculate_ID})
                                    End If
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Details", "Details", New With {.id = item.Calculate_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @If (item.IsQuotation = False) Then
                                        @Html.ActionLink("Delete", "Delete", New With {.id = item.Calculate_ID})
                                    End If
                                </td>
                            </tr>
                        Next
