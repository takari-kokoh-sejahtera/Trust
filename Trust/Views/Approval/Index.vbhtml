@ModelType PagedList.IPagedList(Of Trust.Trust.Tr_Approval)
                            ...
                            @<tr>
                                <td style="white-space:nowrap">
                                    ...
                                    @if (item.Approve) Then
                                        @Html.ActionLink("Approve", "Create", New With {.id = item.Approval_ID})
                                    End If
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Print", "Zip", "Quotation", New With {.id = item.Quotation_ID}, Nothing)
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Detail", "Detail", New With {.id = item.Approval_ID}, Nothing)
                                </td>
