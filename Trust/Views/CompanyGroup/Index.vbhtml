@ModelType PagedList.IPagedList(Of Trust.Trust.Ms_Customer_CompanyGroups)
@Imports PagedList.Mvc
@Code
    ViewData("Title") = "CompanyGroup"
End Code
                    ...
                    <tbody>
                        @For Each item In Model
                            @<tr>
                                ...
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Edit", "Edit", New With {.id = item.CompanyGroup_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Details", "Details", New With {.id = item.CompanyGroup_ID})
                                </td>
                                <td style="white-space:nowrap">
                                    @Html.ActionLink("Delete", "Delete", New With {.id = item.CompanyGroup_ID})
                                </td>
                            </tr>
                        Next
                    </tbody>
