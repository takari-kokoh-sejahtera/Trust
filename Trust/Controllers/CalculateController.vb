...
#End Region
                    ...
                    If GoalSeek = "UpFrontFee" Then
                        ...
                        '                            If DP = GoalSeekVal Then GoTo lastDP
                        '                            If DP > GoalSeekVal Then
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.01
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.01
                        ...
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.00000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.00000001
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.000000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.000000001
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.0000000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.0000000001
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.00000000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.00000000001
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.000000000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.000000000001
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.0000000000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP
                        '                                DPPercent = DPPercent + 0.0000000000001
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP > GoalSeekVal
                        '                                    DPPercent = DPPercent - 0.00000000000001
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP < GoalSeekVal Then
                        '                                    DPPercent = DPPercent + 0.00000000000001
                        ...
                        '                                End If
                        'lastDP:
                        '                            ElseIf DP < GoalSeekVal Then
                        '                                While DP < GoalSeekVal
                        '                                    DPPercent = DPPercent + 0.01
                        '                                    DP = CalDP(Cost_Price, DPPercent)
                        '                                End While
                        '                                If DP = GoalSeekVal Then GoTo lastDP1
                        '                                DPPercent = DPPercent - 0.01
                        '                                DP = CalDP(Cost_Price, DPPercent)
                        '                                While DP < GoalSeekVal
                        '                                    DPPercent = DPPercent + 0.001
